...
#ifndef MyAppIncludeTextureInterop
  #define MyAppIncludeTextureInterop 0
#endif

#if MyAppIncludeTextureInterop
  #ifndef TextureInteropSpoutLibrarySource
    #error "TextureInteropSpoutLibrarySource must be defined when MyAppIncludeTextureInterop is enabled"
  #endif
#endif
...
#ifdef MyAppVstBundleDir
Source: "{#MyAppVstSource}"; DestDir: "{code:GetVstInstallDir}\{#MyAppVstBundleDir}"; Flags: ignoreversion recursesubdirs createallsubdirs
#else
...
[Registry]
Root: HKA; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\{#MyAppExeName}"; ValueType: string; ValueName: ""; ValueData: "{code:GetExeInstallDir}\{#MyAppExeName}"; Flags: uninsdeletekey
Root: HKA; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\{#MyAppExeName}"; ValueType: string; ValueName: "Path"; ValueData: "{code:GetExeInstallDir}"; Flags: uninsdeletevalue
